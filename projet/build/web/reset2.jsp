<%-- 
    Document   : reset2
    Created on : 23 mai 2018, 11:04:00
    Author     : HITMAN
--%>
...
if (window.addEventListener) {
    ...
    <body>
        ...
        <h1><marquee>Recherche par ID</marquee></h1><br>
    <center>   <table border="1">
            <tr><td>id</td> <td>nom</td></tr>
            <%// Patient p= new Patient((Patient)session.getAttribute("Patient"));%>
            <tr> <td><%=((Patient)session.getAttribute("sess")).getId()%><input type="radio" name="id" value="<%=((Patient)session.getAttribute("sess")).getId()%>"</td> <td><input type="text" name="nom" value="<%=((Patient)session.getAttribute("sess")).getNom()%>"</td> </tr>
         <tr> <td><button type="submit" value="Modifier" name="b1">Modifier</button></td>
                    <td><button type="submit" value="Supprimer" name="b1">Supprimer</button></td></tr>
        </table></center>
        </form>
    </body>
</html>
