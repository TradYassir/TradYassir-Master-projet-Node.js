<%-- 
    Document   : rest
    Created on : 23 mai 2018, 08:09:48
    Author     : HITMAN
--%>
        ...
        <center> <table border=1>
         ...
         <%
            ...
            for(int i=0;i<list.size();i++){
                %>
                <tr> <td><%=list.get(i).getId()%><input type="radio" name="id" value="<%=list.get(i).getId()%>"></td> <td><input type="text" name="nom" value="<%=list.get(i).getNom()%>"></td> 
                </tr>
